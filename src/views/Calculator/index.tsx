...
function Calculator() {
    ...
    const trimmedStakingAPY = trim(890 * 100, 1);
    ...
    const trimmedWmemoPrice = trim(wMemoMarketPrice, 2);
    ...
    const calcNewBalance = () => {
        ...
        balance = balance * wMemoMarketPrice;
    ...
    useEffect(() => {
        ...
        const newPotentialReturn = newBalance * (parseFloat(trimmedWmemoPrice) || 0);
                    ...
                    <Grid className="calculator-card-grid" container direction="column" spacing={2}>
                        <Grid item>
                            <div className="calculator-card-header">
                                ...
                                <p className="calculator-card-header-subtitle">#blame-catalyst</p>
                            </div>
                        </Grid>
                        <Grid item>
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12} sm={4} md={4} lg={4}>
                                        <div className="calculator-card-tvl">
                                            <p className="calculator-card-metrics-title">APY of our Hearts</p>
                                            <p className="calculator-card-metrics-value">
                                            ...
                                            {isAppLoading ? (
                                                ...
                                                <>
                                                    {new Intl.NumberFormat("en-US", {
                                                        ...
                                                        maximumFractionDigits: 0,
                                                        minimumFractionDigits: 0,
                                                    }).format(calcNewBalance())}
                                                </>
                                            )}
                                        </p>
                                    </div>
                                    <div className="data-row lambos">
                                        <p className="data-row-name">Potential number of lambos</p>
                                        <p className="data-row-value">{isAppLoading ? <Skeleton width="80px" /> : <>{Math.floor(Number(trim(calcNewBalance(), 2)) / 220000)}</>}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
